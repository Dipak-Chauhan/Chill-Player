...
class MiniPlayerHero extends ConsumerWidget {
  ...
  Widget _buildMini(BuildContext context, WidgetRef ref, dynamic song, VoidCallback open) {
                    ...
                    children: [
                      ...
                      if (extraControls)
                        IconButton(
                          ...
                          onPressed: () => ref.read(audioPlayerProvider).seekToPrevious(),
                        ),
                      IconButton(
                      ...
                      if (extraControls)
                        IconButton(
                          ...
                          iconSize: 32,
                          color: Theme.of(context).colorScheme.onSurfaceVariant,
                          onPressed: () => ref.read(audioPlayerProvider).seekToNext(),
                        ),
                      const SizedBox(width: 8),
                    ],
                  ),
                  Align(
                    ...
                    child: Consumer(
                      builder: (context, ref, child) {
                        ...
                        final durMs = song.duration.inMilliseconds > 0 ? song.duration.inMilliseconds : 1;
